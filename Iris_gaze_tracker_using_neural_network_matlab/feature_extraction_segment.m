...
for imp=1:2 % number to how many person images 
            % wants to train
a1=(imread([num2str(imp) '.bmp']));
% a=a1;
% c=1;
% for i=1:100
%   for j=1:100
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%this code to search for the centre coordinates of the pupil and the iris
...
for i=1:2 % here need to modify the no of images to train
 if i==1
    P=testdat(i,:);
 else
    P=[P,testdat(i,:)];
...
% total_feature = [testdat T];
save feature_extraction_11apr testdat T